        ...
        <div class="flex items-center gap-4 ms-auto">
            ...
            <div class="lg:flex hidden">
                <div class="hs-dropdown relative inline-flex [--placement:bottom-right]">
                    <a id="hs-dropdown-with-header" href="{{ route('home') }}" class="hs-dropdown-toggle inline-flex flex-shrink-0 justify-center items-center gap-2 h-10 w-10 rounded-full font-medium text-default-700 align-middle bg-default-100 hover:text-primary transition-all text-xs">
                ...
                <div class="hs-dropdown relative inline-flex ">
                    <button id="hs-dropdown-with-header" type="button" class="hs-dropdown-toggle inline-flex flex-shrink-0 justify-center items-center gap-2 rounded-full font-medium text-default-700 align-middle transition-all text-xs">
                        ...
                        <div class="lg:block text-start hidden">
                            <p class="text-sm font-medium text-default-700">{{ Auth::check() ? Auth::user()->name : 'null' }}</p>
                            <p class="text-xs text-default-500 mt-1">{{ Auth::check() ? Auth::user()->role : 'null' }}</p>
                        </div>
                    </button>
