        ...
        <div class="flex justify-center items-center lg:max-w-lg">
            <div class="flex flex-col h-full">
                <div class="shrink">
                    ...
                    <div class="">
                        <h1 class="text-3xl font-semibold text-default-800 mb-2">Reset Password</h1>
                    ...
                    <div class="pt-16">
                        <div class="mb-6">
                            ...
                            <input id="new_password" class="block w-full rounded-full py-2.5 px-4 bg-white border border-default-200 focus:ring-transparent focus:border-default-200 dark:bg-default-50" type="email" placeholder="Enter your email">
                        </div>
                        <div class="mb-6">
                            <label class="block text-sm font-medium text-default-900 mb-2" for="confirm_new_password">Confirm New Password</label>
                            <input id="confirm_new_password" class="block w-full rounded-full py-2.5 px-4 bg-white border border-default-200 focus:ring-transparent focus:border-default-200 dark:bg-default-50" type="email" placeholder="Enter your email">
                        </div>
                        <div class="flex flex-col justify-center gap-4 mb-6">
                            <a href="{{ route('second', ['auth', 'login']) }}" class="relative inline-flex items-center justify-center px-6 py-3 rounded-full text-base bg-primary text-white capitalize transition-all hover:bg-primary-500 w-full">
                                Reset Password
                            </a>
                        </div>
                        <div class="mb-6">
                ...
                <div class="grow flex items-end justify-center mt-16">
                    <p class="text-default-950 text-center mt-auto">Back to<a href="{{ route('second', ['auth', 'login']) }}" class="text-primary ms-1"><span class="font-medium">Login</span></a></p>
                </div>
            </div>
        </div>
    </div>
