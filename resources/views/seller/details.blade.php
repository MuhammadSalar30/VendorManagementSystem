@extends('layouts.admin', ['subtitle' => "Sellers", 'title' => "Sellers Details"])
...
<div class="grid lg:grid-cols-3 grid-cols-1 gap-6">
    <div class="lg:col-span-1">
        <div class="p-6 rounded-lg border border-default-200">
            <img src="/images/avatars/avatar4.png" alt="" class="w-24 rounded-full p-1 border border-gray-200 bg-gray-100 dark:bg-gray-700 dark:border-gray-600">
            ...
            <div class="text-start mt-6">
                ...
                <p class="text-zinc-400 mb-3"><strong>Full Name :</strong> <span class="ms-2">Kaiya Botosh</span></p>

                <p class="text-zinc-400 mb-3"><strong>Mobile :</strong><span class="ms-2">(123) 123 1234</span></p>

                <p class="text-zinc-400 mb-3"><strong>Email :</strong> <span class="ms-2 ">user@email.domain</span></p>
        ...
        <div class="border rounded-lg border-default-200">
            <div class="px-6 py-4">
                <div class="flex flex-wrap justify-between items-center gap-6">
                    <h4 class="text-xl font-medium text-default-900">Selles Order history</h4>
