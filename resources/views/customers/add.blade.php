@extends('layouts.admin', ['subtitle' => "Customers", 'title' => "Add Customers"])
    ...
    <div class="p-6">
        <div class="grid lg:grid-cols-2 gap-6 mb-6">
            ...
            <div>
                ...
                <input id="user_name" class="block w-full bg-transparent rounded-full py-2.5 px-4 border border-default-200 focus:ring-transparent focus:border-default-200 dark:bg-default-50" type="text" placeholder="Enter Your User Name">
            </div>
