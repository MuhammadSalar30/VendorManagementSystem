@extends('layouts.admin', ['subtitle' => 'Customers', 'title' => 'Customers List'])
    ...
    <div class="p-6">
        <div class="flex flex-wrap justify-between items-center gap-4">
            ...
            <div class="flex flex-wrap items-center gap-2">
                ...
                <a href="{{ route('second', ['customers', 'add']) }}" class="px-6 py-2.5 inline-flex text-white text-sm rounded-md bg-primary ">
                ...
                <div class="hs-dropdown relative inline-flex">
                    <button type="button" class="hs-dropdown-toggle flex items-center gap-2 font-medium text-default-700 text-sm py-2.5 px-4 xl:px-5 rounded-md bg-default-100 transition-all">
                        Filter <i data-lucide="chevron-down" class="h-4 w-4"></i>
                ...
                <table class="min-w-full divide-y divide-default-200">
                    <thead class="bg-default-100">
                        <tr>
                            ...
                            <th scope="col" class="px-6 py-4 text-start whitespace-nowrap text-sm font-medium text-default-500">Customer Name</th>
                            <th scope="col" class="px-6 py-4 text-start whitespace-nowrap text-sm font-medium text-default-500">Email</th>
                            <th scope="col" class="px-6 py-4 text-start whitespace-nowrap text-sm font-medium text-default-500">Phone</th>
                            <th scope="col" class="px-6 py-4 text-start whitespace-nowrap text-sm font-medium text-default-500">Orders</th>
                            <th scope="col" class="px-6 py-4 text-start whitespace-nowrap text-sm font-medium text-default-500">Order Total</th>
                            <th scope="col" class="px-6 py-4 text-start whitespace-nowrap text-sm font-medium text-default-500">Customer Since</th>
                    ...
                    <tbody class="divide-y divide-default-200">
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-base text-default-800">Paityn Herwitz</td>
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-base text-default-800">Randy Siphron</td>
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-base text-default-800">Livia Kenter</td>
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-base text-default-800">Ann Vetrovs</td>
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-base text-default-800">Roger Korsgaard</td>
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-base text-default-800">Ruben Calzoni</td>
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-base text-default-800">Talan Dokidis</td>
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-base text-default-800">Carter George</td>
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-base text-default-800">Marilyn Stanton</td>
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-base text-default-800">Emerson Dokidis</td>
