@extends('layouts.admin', ['subtitle' => "Customers", 'title' => "Edit Customers"])
    ...
    <div class="p-6">
        <div class="grid lg:grid-cols-2 gap-6 mb-6">
            <div>
                ...
                <input id="firstName" class="block w-full bg-transparent rounded-full py-2.5 px-4 border border-default-200 focus:ring-transparent focus:border-default-200 dark:bg-default-50" type="text" placeholder="Enter Your First Name" value="Tiana">
            </div>

            <div>
                <label class="block text-sm font-medium text-default-900 mb-2" for="lastName">Last Name</label>
                <input id="lastName" class="block w-full bg-transparent rounded-full py-2.5 px-4 border border-default-200 focus:ring-transparent focus:border-default-200 dark:bg-default-50" type="text" placeholder="Enter Your Last Name" value="Geidt">
            </div>

            <div>
                <label class="block text-sm font-medium text-default-900 mb-2" for="userName">User Name</label>
                <input id="userName" class="block w-full bg-transparent rounded-full py-2.5 px-4 border border-default-200 focus:ring-transparent focus:border-default-200 dark:bg-default-50" type="text" placeholder="Enter Your User Name" value="tianageidt">
            </div>

            <div>
                <label class="block text-sm font-medium text-default-900 mb-2" for="e_mail">Email</label>
                <input id="e_mail" class="block w-full bg-transparent rounded-full py-2.5 px-4 border border-default-200 focus:ring-transparent focus:border-default-200 dark:bg-default-50" type="email" placeholder="demoexample@mail.com" value="tianageidt@mail.com">
            </div>

            <div>
                <label class="block text-sm font-medium text-default-900 mb-2" for="phone_number">Phone Number</label>
                <input id="phone_number" class="block w-full bg-transparent rounded-full py-2.5 px-4 border border-default-200 focus:ring-transparent focus:border-default-200 dark:bg-default-50" type="tel" placeholder="+1-123-XXX-4567" value="+1-123-999-4567">
            </div>
